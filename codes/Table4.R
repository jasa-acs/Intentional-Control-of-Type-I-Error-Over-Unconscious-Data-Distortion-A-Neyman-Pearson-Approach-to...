# Notice that package dsda was installed directly from the tar.gz file downloaded online. All the codes are run under R version 3.3.3
...
save(Isvmr,IIsvmr,Isvm,IIsvm,Ir,IIr,I,II,Inbr,IInbr,Inb,IInb,Irfr,IIrfr,Irf,IIrf,Idsdar,IIdsdar,Idsda,IIdsda,file="Table4.RData")
